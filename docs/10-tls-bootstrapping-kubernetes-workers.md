...
```
worker-2$ sudo kubectl config --kubeconfig=/var/lib/kubelet/bootstrap-kubeconfig set-cluster bootstrap --server='https://192.168.58.30:6443' --certificate-authority=/var/lib/kubernetes/ca.crt
...
- cluster:
    ...
    server: https://192.168.58.30:6443
  name: bootstrap
contexts:
- context:
    cluster: bootstrap
