...
- Set's IP addresses in the range 192.168.5
    ...
    | ------------  | ---------------------- |:-------------:| ------------:| ----------------:|
    | master-1      | kubernetes-ha-master-1 | Master        | 192.168.58.11 |     2711         |
    | master-2      | kubernetes-ha-master-2 | Master        | 192.168.58.12 |     2712         |
    | worker-1      | kubernetes-ha-worker-1 | Worker        | 192.168.58.21 |     2721         |
    | worker-2      | kubernetes-ha-worker-2 | Worker        | 192.168.58.22 |     2722         |
    | loadbalancer  | kubernetes-ha-lb       | LoadBalancer  | 192.168.58.30 |     2730         |
