...
ExecStart=/usr/local/bin/kube-apiserver \\
  ...
  --etcd-servers=https://192.168.58.11:2379,https://192.168.58.12:2379 \\
  --event-ttl=1h \\
...
backend kubernetes-master-nodes
    ...
    balance roundrobin
    option tcp-check
    server master-1 192.168.58.11:6443 check fall 3 rise 2
    server master-2 192.168.58.12:6443 check fall 3 rise 2
EOF
```
...
```
curl  https://192.168.58.30:6443/version -k
```
